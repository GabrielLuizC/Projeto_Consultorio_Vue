<template>
  <div class="cad-form mt-5">
    ...
    <div class="field is-flex is-justify-content-center is-align-items-center">
      <p class="help has-text-weight-bold is-size-6 mr-3">Especialidade</p>
      <div class="control">
        <div class="select">
          <select class="is-hovered">
    ...
    <div class="field is-horizontal">
      <div class="field-body">
        <div class="field">
          <p class="control is-expanded has-icons-left">
            <input class="input" type="text" placeholder="CRM" />
            <span class="icon is-small is-left">
              <i class="fas fa-user"></i>
            </span>
          </p>
    ...
    <div class="field is-horizontal">
      <div class="field-body">
        ...
        <div class="field">
          <p class="control is-expanded has-icons-left has-icons-right">
            <input class="input" type="number" placeholder="% Participação" />
            <span class="icon is-small is-left">
              <i class="fas fa-envelope"></i>
            </span>
          </p>
...
export default class FormMedicoCadastro extends Vue {
  msg!: string;
}
</script>
